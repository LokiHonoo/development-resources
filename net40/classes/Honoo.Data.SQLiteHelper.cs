...
namespace Honoo.Data
{
    ...
    public static class SQLiteHelper
    {
        ...
        {
            SQLiteCommand command = new SQLiteCommand(commandText, connection) { CommandType = commandType };
        ...
        {
            using (SQLiteCommand command = new SQLiteCommand(commandText, connection) { CommandType = commandType })
            {
                if (parameters != null && parameters.Length > 0) { command.Parameters.AddRange(parameters); }
